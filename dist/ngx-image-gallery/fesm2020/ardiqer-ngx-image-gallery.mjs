...
NgxImageGalleryComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: NgxImageGalleryComponent, selectors: [["ngx-image-gallery"]], viewQuery: function NgxImageGalleryComponent_Query(rf, ctx) { if (rf & 1) {
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(NgxImageGalleryComponent, [{
        type: Component,
